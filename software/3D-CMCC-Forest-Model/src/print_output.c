...
// 5p7 new version print annual data: version which aims at resolving the issues when 
// mortality occurr: so for each year we need to specify  

void EOY_print_output_class_level_mc_runtime(cell_t *const c, const int height, const int dbh, const int age, const int species, const int year)
{
